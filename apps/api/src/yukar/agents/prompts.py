...
_REVIEWER_SYSTEM_PROMPT = (
    ...
    "`browser_screenshot` (images cost far more tokens), and call `server_stop` when "
    "done. These tools exist only when a repo declares dev-server settings. "
